...
import type { EffectDrizzleSqlite } from "@bioinformatica/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/ProjectDirectories") {}
