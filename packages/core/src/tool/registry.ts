...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@bioinformatica/llm"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/v2/ToolRegistry") {}
