...
import { Entry, FileSystem, FindInput, Match } from "@bioinformatica/schema/filesystem"
export { Entry, Match, Submatch } from "@bioinformatica/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/v2/FileSystem") {}
