...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@bioinformatica/example/RequestContextRef",
) {}
...
export class ConfigService extends Context.Service<ConfigService, ConfigServiceShape>()(
  "@bioinformatica/example/ConfigService",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@bioinformatica/example/ConfigServiceMap", {
