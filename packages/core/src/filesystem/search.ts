...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.BIOINFORMATICA_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
