...
export { Effect, Rule, Ruleset } from "@bioinformatica/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/v2/Permission") {}
