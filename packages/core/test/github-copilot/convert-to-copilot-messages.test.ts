import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@bioinformatica/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
