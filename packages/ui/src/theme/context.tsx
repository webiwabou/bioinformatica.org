...
const STORAGE_KEYS = {
  THEME_ID: "bioinformatica-theme-id",
  COLOR_SCHEME: "bioinformatica-color-scheme",
  THEME_CSS_LIGHT: "bioinformatica-theme-css-light",
  THEME_CSS_DARK: "bioinformatica-theme-css-dark",
} as const
