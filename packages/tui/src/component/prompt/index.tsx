...
import { registerBioinformaticaSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@bioinformatica/sdk/v2"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.BIOINFORMATICA_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
