export default {
  ...
  parsers: [
    ...
    {
      // `anomalyco` is the upstream (opencode) org that publishes this grammar
      // fork and its queries, not a namespace of ours. Leave it alone when
    ...
    },
    {
      ...
      // Upstream (opencode) org, not ours: see the note on the vue entry above.
