...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new BioinformaticaClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Bioinformatica system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Bioinformatica system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Bioinformatica server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Bioinformatica state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Bioinformatica configuration settings and preferences.
   */
   ...
   *
   * Update global Bioinformatica configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Bioinformatica server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Bioinformatica system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Bioinformatica instances, releasing all resources.
   */
  ...
  /**
   * Upgrade bioinformatica
   *
   * Upgrade bioinformatica to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Bioinformatica configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Bioinformatica configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Bioinformatica instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Bioinformatica system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Bioinformatica.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Bioinformatica is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Bioinformatica.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Bioinformatica sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Bioinformatica session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Bioinformatica session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this Bioinformatica process. Idle interruption is a no-op.
   */
...
export class BioinformaticaClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<BioinformaticaClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    BioinformaticaClient.__registry.set(this, args?.key)
  }
