...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips bioinformatica-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      const request = HttpServerRequest.fromWeb(
        new Request("http://localhost/test", {
          headers: {
            ...
            "x-bioinformatica-workspace": "ws_123",
            "x-custom": "preserved",
          },
        }),
      )
      ...
      expect(forwarded["x-bioinformatica-directory"]).toBeUndefined()
      expect(forwarded["x-bioinformatica-workspace"]).toBeUndefined()
