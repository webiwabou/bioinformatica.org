...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      BIOINFORMATICA_EXPERIMENTAL_WORKSPACES: Flag.BIOINFORMATICA_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.BIOINFORMATICA_EXPERIMENTAL_WORKSPACES = original.BIOINFORMATICA_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
