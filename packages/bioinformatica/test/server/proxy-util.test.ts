...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips bioinformatica-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-bioinformatica-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-bioinformatica-directory")).toBeNull()
      expect(result.get("x-bioinformatica-workspace")).toBeNull()
