...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BIOINFORMATICA_CALLER", () => {
    process.env["BIOINFORMATICA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BIOINFORMATICA_CALLER", () => {
    process.env["BIOINFORMATICA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BIOINFORMATICA_CALLER", () => {
    process.env["BIOINFORMATICA_CALLER"] = "unknown"
