import type { Hooks, PluginInput } from "@bioinformatica/plugin"
import type { Model } from "@bioinformatica/sdk/v2"
import { InstallationVersion } from "@bioinformatica/core/installation/version"
import { OauthCallbackPage } from "@bioinformatica/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Bioinformatica will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
