...
import { AccountStateTable, AccountTable } from "@bioinformatica/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/AccountRepo") {}
