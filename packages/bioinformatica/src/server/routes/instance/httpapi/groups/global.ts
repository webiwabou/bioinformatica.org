...
import "@bioinformatica/core/account"
import "@/server/event"
    ...
    .add(
      HttpApiEndpoint.get("health", GlobalPaths.health, {
        ...
        OpenApi.annotations({
          ...
          summary: "Get health",
          description: "Get health information about the Bioinformatica server.",
        }),
      ),
      HttpApiEndpoint.get("event", GlobalPaths.event, {
        ...
        OpenApi.annotations({
          ...
          description: "Subscribe to global events from the Bioinformatica system using server-sent events.",
        }),
      ),
      HttpApiEndpoint.get("configGet", GlobalPaths.config, {
        ...
        OpenApi.annotations({
          ...
          description: "Retrieve the current global Bioinformatica configuration settings and preferences.",
        }),
      ),
      HttpApiEndpoint.patch("configUpdate", GlobalPaths.config, {
        ...
        OpenApi.annotations({
          ...
          description: "Update global Bioinformatica configuration settings and preferences.",
        }),
      ),
      HttpApiEndpoint.post("dispose", GlobalPaths.dispose, {
        ...
        OpenApi.annotations({
          ...
          description: "Clean up and dispose all Bioinformatica instances, releasing all resources.",
        }),
      ),
      HttpApiEndpoint.post("upgrade", GlobalPaths.upgrade, {
        ...
        OpenApi.annotations({
          ...
          summary: "Upgrade bioinformatica",
          description: "Upgrade bioinformatica to the specified version or latest if not specified.",
        }),
      ),
    )
