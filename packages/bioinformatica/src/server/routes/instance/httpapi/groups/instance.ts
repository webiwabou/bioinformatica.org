...
export const InstanceApi = HttpApi.make("instance")
      ...
      .add(
        HttpApiEndpoint.post("dispose", InstancePaths.dispose, {
          ...
          OpenApi.annotations({
            ...
            description: "Clean up and dispose the current Bioinformatica instance, releasing all resources.",
          }),
        ),
        HttpApiEndpoint.get("path", InstancePaths.path, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the Bioinformatica instance.",
          }),
        ),
        ...
        HttpApiEndpoint.get("command", InstancePaths.command, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all available commands in the Bioinformatica system.",
          }),
        ),
        HttpApiEndpoint.get("agent", InstancePaths.agent, {
          ...
          OpenApi.annotations({
            ...
            summary: "List agents",
            description: "Get a list of all available AI agents in the Bioinformatica system.",
          }),
        ),
        HttpApiEndpoint.get("skill", InstancePaths.skill, {
          ...
          OpenApi.annotations({
            ...
            summary: "List skills",
            description: "Get a list of all available skills in the Bioinformatica system.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "bioinformatica experimental HttpApi",
      version: "0.0.1",
