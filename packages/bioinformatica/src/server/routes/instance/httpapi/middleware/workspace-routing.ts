...
>()("@bioinformatica/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@bioinformatica/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.BIOINFORMATICA_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.BIOINFORMATICA_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-bioinformatica-directory"] || process.cwd()
}
