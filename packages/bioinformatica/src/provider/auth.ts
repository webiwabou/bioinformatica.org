...
import type { AuthOAuthResult, Hooks } from "@bioinformatica/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/ProviderAuth") {}
