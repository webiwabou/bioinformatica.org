...
import { llmClient } from "@bioinformatica/core/effect/app-node-platform"
...
import type { LLMEvent } from "@bioinformatica/llm"
import { LLMClient } from "@bioinformatica/llm/route"
import type { LLMClientService } from "@bioinformatica/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via bioinformatica's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @bioinformatica/llm. It
