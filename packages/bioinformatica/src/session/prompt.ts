...
import { MAX_STEPS_PROMPT } from "@bioinformatica/core/session/runner/max-steps"
...
import { LLMEvent } from "@bioinformatica/llm"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/SessionPrompt") {}
