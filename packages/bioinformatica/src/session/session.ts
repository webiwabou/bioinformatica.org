...
import { Slug } from "@bioinformatica/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@bioinformatica/llm"
...
import { locationServiceMapLayer } from "@bioinformatica/core/location-services"
...
import { PartTable, SessionTable } from "@bioinformatica/core/session/sql"
...
import { NonNegativeInt, optional } from "@bioinformatica/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".bioinformatica", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/Session") {}
