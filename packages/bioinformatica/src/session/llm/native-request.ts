import type { JsonSchema, LLMRequest, ProviderMetadata } from "@bioinformatica/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@bioinformatica/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @bioinformatica/llm request objects from bioinformatica's session/AI SDK-shaped data.
  return LLM.request({
