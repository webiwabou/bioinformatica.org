...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const bioinformaticaProjectID = input.model.providerID.startsWith("bioinformatica")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("bioinformatica")
        ? {
            ...(bioinformaticaProjectID ? { "x-bioinformatica-project": bioinformaticaProjectID } : {}),
            "x-bioinformatica-session": input.sessionID,
            "x-bioinformatica-request": input.user.id,
            "x-bioinformatica-client": input.flags.client,
