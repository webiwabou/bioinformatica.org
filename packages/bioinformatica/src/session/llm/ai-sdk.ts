import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@bioinformatica/llm"
...
// Move this extraction into @bioinformatica/llm when Copilot is handled by the native runtime.
