...
import type { AssistantMessage as BioinformaticaAssistantMessage, Message } from "@bioinformatica/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@bioinformatica/core/effect/app-node"
...
export type AssistantTokenCost = Pick<BioinformaticaAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<BioinformaticaAssistantMessage, "role"> &
  Partial<Pick<BioinformaticaAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@bioinformatica/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@bioinformatica/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@bioinformatica/ACPUsage") {}
