...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@bioinformatica/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@bioinformatica/ACPDirectory") {}
