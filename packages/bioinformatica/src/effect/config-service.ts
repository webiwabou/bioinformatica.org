 ...
 *   "@bioinformatica/ServerAuthConfig",
 *   {
 *     password: Config.string("BIOINFORMATICA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("BIOINFORMATICA_SERVER_USERNAME").pipe(Config.withDefault("bioinformatica")),
 *   },
 * ) {}
 *
