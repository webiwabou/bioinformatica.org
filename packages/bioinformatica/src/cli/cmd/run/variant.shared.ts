...
//
// The saved variant persists across sessions in ~/.local/state/bioinformatica/model.json
...
class Service extends Context.Service<Service, VariantService>()("@bioinformatica/RunVariant") {}
