...
import type { Event, GlobalEvent, BioinformaticaClient } from "@bioinformatica/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@bioinformatica/RunStreamTransport") {}
