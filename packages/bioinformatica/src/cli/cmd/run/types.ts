// Shared type vocabulary for the direct interactive mode (`bioinformatica --mini`).
//
...
import type { BioinformaticaClient, PermissionRequest, QuestionRequest, ToolPart } from "@bioinformatica/sdk/v2"
...
type PromptModel = Parameters<BioinformaticaClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<BioinformaticaClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<BioinformaticaClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<BioinformaticaClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<BioinformaticaClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<BioinformaticaClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<BioinformaticaClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<BioinformaticaClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<BioinformaticaClient["question"]["reject"]>[0]
