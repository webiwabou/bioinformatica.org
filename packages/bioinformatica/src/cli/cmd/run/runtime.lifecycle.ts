...
import { openEditor } from "@bioinformatica/tui/editor"
import { registerBioinformaticaKeymap } from "@bioinformatica/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerBioinformaticaKeymap(keymap, renderer, input.tuiConfig)
