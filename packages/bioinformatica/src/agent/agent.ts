...
import { AbsolutePath, type DeepMutable } from "@bioinformatica/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".bioinformatica", "plans", "*.md")]: "allow",
