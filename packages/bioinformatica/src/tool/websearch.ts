...
import { checksum } from "@bioinformatica/core/util/encode"
...
export function selectWebSearchProvider(sessionID: string, flags = { exa: false, parallel: false }): WebSearchProvider {
  const override = process.env.BIOINFORMATICA_WEBSEARCH_PROVIDER
...
function parallelAuthHeaders() {
  const headers = { "User-Agent": `bioinformatica/${InstallationVersion}` }
