...
import { EventSequenceTable, EventTable } from "@bioinformatica/core/event/sql"
...
import { WorkspaceEvent } from "@bioinformatica/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@bioinformatica/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        BIOINFORMATICA_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        BIOINFORMATICA_WORKSPACE_ID: config.id,
        BIOINFORMATICA_EXPERIMENTAL_WORKSPACES: "true",
