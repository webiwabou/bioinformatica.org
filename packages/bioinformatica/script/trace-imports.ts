...
// The package this script traces: its own parent directory, so the script works
// from any checkout instead of one machine's home directory. `BASE_DIR` overrides
// it if you want to trace a different package.
const BASE_DIR = process.env["BASE_DIR"] ?? path.resolve(import.meta.dirname, "..")
